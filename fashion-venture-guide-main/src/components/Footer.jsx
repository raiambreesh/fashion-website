    ...
    <footer className="bg-gray-50 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div>
            <h2 className="text-lg font-semibold mb-4">MONO</h2>
            <p className="text-gray-600 max-w-xs">
              Minimalist fashion essentials designed with attention to detail and quality craftsmanship.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/category/men" className="text-gray-600 hover:text-black transition-colors">Men</Link></li>
              <li><Link to="/category/women" className="text-gray-600 hover:text-black transition-colors">Women</Link></li>
              <li><Link to="/category/kids" className="text-gray-600 hover:text-black transition-colors">Kids</Link></li>
              <li><Link to="/category/accessories" className="text-gray-600 hover:text-black transition-colors">Accessories</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/shipping" className="text-gray-600 hover:text-black transition-colors">Shipping Policy</Link></li>
              <li><Link to="/returns" className="text-gray-600 hover:text-black transition-colors">Returns & Exchanges</Link></li>
            </ul>
          </div>
        </div>
        
        <div className="border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm">© {new Date().getFullYear()} MONO. All rights reserved.</p>
